...
export default function ContactUs() {
  return (
    <div className="mt-[48px] max-w-[560px] sm:max-w-[1120px] m-auto " id="contact">
      ...
      <div className=" grid sm:grid-cols-3 grid-cols-1 gap-4 mt-[40px] ">
        <div className="bg-[#F3F5F7] text-center flex justify-center items-center ">
          <div className="flex flex-col items-center justify-center gap-3 py-4">
            <Image src="/adress.png" height={32} width={32} alt="Adress" />
        ...
        <div className="bg-[#F3F5F7] text-center flex justify-center items-center ">
          <div className="flex flex-col items-center justify-center gap-3 py-4">
            <Image src="/call.png" height={32} width={32} alt="Adress" />
            <h6 className="text-[#6C7275] font-bold text-[16px] leading-4">
              Contact
            </h6>
            <span className="font-semibold text-[16px] leading-[26px] text-[#141718]">
        ...
        <div className="bg-[#F3F5F7] text-center flex justify-center items-center ">
          <div className="flex flex-col items-center justify-center gap-3 py-4">
            <Image src="/mail.png" height={32} width={32} alt="Adress" />
            <h6 className="text-[#6C7275] font-bold text-[16px] leading-4">
              Email
            </h6>
            <span className="font-semibold text-[16px] leading-[26px] text-[#141718]">
              GiorgobianiLasha77@gmail.com
            </span>
          </div>
        </div>
      </div>
