...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-screen sm:min-h-[150vh] md:min-h-[200vh] shrink-0 transform flex-col items-center justify-start py-10 sm:py-40 md:py-80 [perspective:800px] ml-[10px] mr-[10px]"
    >
      <motion.h2
        style={{
    ...
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img
          src={src as string}
          alt="aceternity logo"
          className="absolute inset-0 h-full w-full md:w-[32rem] rounded-lg object-cover object-left-top top-[-50px]"
        />
      </motion.div>
    </div>
  );
